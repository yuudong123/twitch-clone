...
public class Main2HighViewerAdapter extends RecyclerView.Adapter<Main2HighViewerAdapter.ViewHolder> {

    ItemMenu2LiveBinding binding;
    LayoutInflater inflater;
    ArrayList<UserDTO> list;

    public Main2HighViewerAdapter(LayoutInflater inflater, ArrayList<UserDTO> list) {
    ...
    @NonNull
    @Override
    public Main2HighViewerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = ItemMenu2LiveBinding.inflate(inflater,parent,false);
        return new Main2HighViewerAdapter.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull Main2HighViewerAdapter.ViewHolder holder, int i) {
